...
let eStructureVM = new Vue({
  ...
  methods: {
    ...
    getChartData() {
      axios({
          url: HEADER + '/energyStructureAnalysis/check_getLocationStructureMeterData.do',
          params: {
        ...
        .then(({
          ...
          let chartData = [{
              value: data.data[0].WaterPumpSystem,
              name: '水泵系统'
            },
            {
              value: data.data[0].AirConditionerSystem,
              name: '空调系统'
            },
            {
              value: data.data[0].ElevatorSystem,
              name: '电梯系统'
            },
            {
              value: data.data[0].lightingSystem,
              name: '公共照明'
            },
            {
              value: data.data[0].other,
              name: '其他'
            }
          ]
