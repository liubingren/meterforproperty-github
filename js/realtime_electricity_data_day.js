import {
  ...
  let realtimeElectricityData = new Vue({
    el: '#realtime_electricity_data_day',
    data(){
        return  {
    ...
    methods: {
        ...
        searching(e,from){
            ...
            if(this.tabType==='showNumber'){
                ...
                axios.get(HEADER+'dayPowerData/check_wdetail.do',{
                    params: {
                        page:this.WCurrentPage,
                        pagesize:10,
                        mid:this.midSelect,
                ...
                .then((response) => {
                    ...
                    this.WCurrentPage=response.data.data.currentPage
                    this.WTotalPage=response.data.data.allRow
                    this.initTabtypeTable(this.tabType,dataList)
                })
                ...
                axios.get(HEADER+'dayPowerData/check_list.do',{
                    params: {
                        page:page,
                        pagesize:10,
        ...
        initTabtypeTable(tabType,dataList){
            ...
            // 示数
            if(tabType==='showNumber'&&dataList){
        ...
        rowClick(data,index){
            ...
            if(this.tabType!=='showNumber'){
                ...
                // 获取子级详细数据
                axios.get(HEADER+'dayPowerData/check_detail.do',{
                    params: {
                        mid,
                        dataType,
                        date:this.formatDate()
        ...
        getMeterTypeList(e){
            ...
            if(this.productTypeSelect!=='' && this.electricTypeSelect!=='' && sessionStorage.getItem('unitId')){
                axios.get(HEADER+'dayPowerData/check_getMeterTypeList.do',{
                    params: {
                        meter_type:this.productTypeSelect,
                        use_electricity_type_id:this.electricTypeSelect,
                        location_id:sessionStorage.getItem('unitId')
    ...
    mounted () {
        axios.get(HEADER+'dayPowerData/check_getProductTypeList.do')
        .then((response) => {
        ...
        axios.get(HEADER+'dayPowerData/check_getUseElectricityTypeList.do')
        .then((response) => {
